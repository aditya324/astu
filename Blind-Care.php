              ...
              <div class="row g-3">
                ...
                <div class="col-md-5">
                  <table class="table table-sm align-middle mb-2">
                    <tbody>
                      <tr>
                        <th scope="row" class="fw-normal">Network</th>
                        <td>Centers of Excellence + partner hospitals</td>
                      </tr>
                      <tr>
                        <th scope="row" class="fw-normal">Quality</th>
                        <td>Pediatric anesthesia, infection control, outcomes registry</td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div class="row g-3">
                ...
                <div class="col-md-5">
                  <table class="table table-sm align-middle mb-2">
                    <tbody>
                      <tr>
                        <th scope="row" class="fw-normal">School Integration</th>
                        <td>IEP support + teacher training</td>
                      </tr>
                      <tr>
                        <th scope="row" class="fw-normal">Access</th>
                        <td>Device lending library & maintenance</td>
                      </tr>
                    </tbody>
                  </table>
                  <a href="./donation.php" class="btn btn-primary btn-sm w-100"
              ...
              <div class="row g-3">
                ...
                <div class="col-md-5">
                  <table class="table table-sm align-middle mb-2">
                    <tbody>
                      <tr>
                        <th scope="row" class="fw-normal">Trials</th>
                        <td>Usability pilots in schools & rehab centers</td>
                      </tr>
                      <tr>
                        <th scope="row" class="fw-normal">Data Ethics</th>
                        <td>Consent, privacy, and safety-by-design</td>
                      </tr>
                    </tbody>
                  </table>
                  <a href="./donation.php" class="btn btn-primary btn-sm w-100"

          ...
          <div
            ...
            <div class="footer-wiget-menu">
              <!-- <ul>
                ...
                <li>
                  <a href="#"><i class="bi bi-chevron-double-right"></i> Trusted
                    Franchise</a>
                </li>
                <li>
                  <a href="#"><i class="bi bi-chevron-double-right"></i> Warehoues
                    Storage</a>
                </li>
                <li>
                  <a href="#"><i class="bi bi-chevron-double-right"></i> Real Time
                    Tracking</a>
                </li>
                <li>

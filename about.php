...
<body>
	...
	<!-- Start About Area -->
	<!--==================================================-->
	<div class="about-area inner-page wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1s">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="section-title text-center">
						...
						<div class="section-sub-titile">
							<h4>Raising Your Helping Han</h4>
						</div>
						<div class="section-sub-thumb">
							<img src="assets/images/slider/banner-icon.png" alt="">
						</div>
						<div class="section-main-title">
							<h2>Be The Reason Of Someone Smiless</h2>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="service-content">
							...
							<div class="process-ber-plugin">
								<div id="bar1" class="barfiller">
									<span class="fill" data-percentage="70" style="background: rgb(22, 181, 151); width: 360.691px; transition: width 7s ease-in-out 0s;"></span>
								</div>
							</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="service-text">
						<h4>We work creatively and specially for our client <a href="#">Check Our Work</a></h4>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="blog-area wow fadeInUp" data-wow-delay="0.10s" data-wow-duration="1s">
		<div class="container">
			...
			<div class="row">
					...
					<div class="blog-items-box">
						...
						<div class="blog-content">
							...
							<div class="blog-title">
								<h4><a href="blog-details.html">Retail banks wakeup to digital</a></h4>
							</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-items-box inner2">
						<div class="blog-thumb">
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-items-box inner">
						<div class="blog-thumb">
